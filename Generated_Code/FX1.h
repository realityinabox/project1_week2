...
#define FX1_PARSE_COMMAND_ENABLED  0 /* set to 1 if method ParseCommand() is present, 0 otherwise */
...
#define FX1_DIE_TEMP_OFFSET 24 /* offset to temperature reading as value on device is not calibrated */
